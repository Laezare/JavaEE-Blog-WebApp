...
<head>
<meta charset="utf-8" />
<title>Création de post - Blog</title>
<link rel="stylesheet"
...
<body>
	...
	<form method="post" action="/Blog/CreatePost">
		<fieldset>
			<div class="card-body">
				<legend style="font-size: 2em; color: #007BFF; margin-bottom: 1em">Création
					d'article</legend>
				<p>Vous pouvez ajouter un article via ce formulaire.</p>
				<p style="color: green">${resultat}</p>

				<div class="auteur-group">
					<label for="auteur">Auteur </label> <input
						class="form-control col-md-2" type="text" id="auteur"
						name="auteur" value="" size="15" maxlength="25" />
				</div>
				<br />
				<div class="titre-group">
					<label for="titre">Titre </label> <input
						class="form-control col-md-2" type="text" id="titre" name="titre"
