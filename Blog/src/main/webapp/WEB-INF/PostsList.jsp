...
<head>
<meta charset="utf-8" />
<title>Liste des postes - Blog</title>
<link rel="stylesheet"
...
<body>
				...
				<div class="col-lg-8 col-md-10 mx-auto">
					<div class="post-heading">
						<h1
							...
							La liste de tout les postes</h1>
					</div>
				</div>
			</div>
		</div>
	...
	<h1 style="color: #007BFF; margin-top: 1em">Liste des Posts</h1>
			...
			<div class="row">
				...
				<div class="column">
					<form action=/Blog/UpdatePost>
						<button type="submit" value="${article.id}" name="Modifier"
							class="btn btn-warning" style="margin: 0.5em">Modifier</button>
					</form>
				</div>
				<div class="column">
					<form method="post" action=/Blog/PostsList>
						<button type="submit" value="${article.id}" name="Supprimer"
